...
const TourTransports = () => {
    ...
    useEffect(() => {
        ...
        tourService.getTransports().then((data) => setItems(data));
    }, []);
    ...
    const saveItem = () => {
        ...
        if (title.trim()) {
            ...
            toursService.saveTransports({ ...item });
            setItemDialog(false);
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Manage Transports</h5>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        currentPageReportTemplate="Showing {first} to {last} of {totalRecords} transports"
