...
const TourFacilities = () => {
    ...
    useEffect(() => {
        ...
        tourService.getFacilities().then((data) => setItems(data));
    }, []);
    ...
    const saveItem = () => {
        ...
        if (title.trim()) {
            ...
            toursService.saveFacilities({ ...item });
            setItemDialog(false);
            toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Facility has been saved', life: 2000 });
        }
    };
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="sortOrder" header="Sort order" sortable headerStyle={{ width: '10%', minWidth: '10%' }}></Column>
                        <Column field="id" header="Id" hidden headerStyle={{ width: '5%', minWidth: '10rem' }}></Column>
                    </DataTable>

                    <Dialog visible={itemDialog} style={{ width: '450px' }} header={`Facility [${id}]`} modal className="p-fluid" footer={itemDialogFooter} onHide={onCancelDialog}>
                        <div className="field">
