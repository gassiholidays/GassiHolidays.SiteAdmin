...
const TopDestinations = () => {
    ...
    useEffect(() => {
        ...
        tourService.getTopDestinations().then((data) => setItems(data));
    }, []);
    ...
    const saveItem = () => {
        ...
        if (title.trim()) {
            ...
            toursService.saveDestinationTop({ ...item });
            setItemDialog(false);
            toast.current.show({ severity: 'success', summary: 'Successful', detail: 'Destination has been saved', life: 2000 });
        }
    };
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Manage Destinations Top</h5>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        currentPageReportTemplate="Showing {first} to {last} of {totalRecords} destinations top"
                        globalFilter={globalFilter}
                        emptyMessage="No destinations top found."
                        header={header}
                        responsiveLayout="scroll"
                    >
                        <Column body={actionBodyTemplate} headerStyle={{ width: '7%', minWidth: '7%' }}></Column>
                        <Column field="isActive" header="Active" body={isActiveBodyTemplate} headerStyle={{ width: '5%', minWidth: '5%' }}></Column>
                        <Column field="title" header="Title" sortable headerStyle={{ width: '44%', minWidth: '10rem' }}></Column>
                        <Column field="sortOrder" header="Sort" sortable headerStyle={{ width: '5%', minWidth: '5%' }}></Column>
                    ...
                    <Dialog visible={itemDialog} style={{ width: '450px' }} header={`Destination top [${id}]`} modal className="p-fluid" footer={itemDialogFooter} onHide={onCancelDialog}>
                        ...
                        <div className="formgrid grid">
                            ...
                            <div className="field-checkbox vertical-align-middle">
                                <Checkbox inputId="top-destination-is-active" checked={isActive} onChange={e => setIsActive(e.checked)} />
                                <label htmlFor="top-destination-is-active">Is active</label>
                            </div>
                        </div>
                    </Dialog>
