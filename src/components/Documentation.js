        ...
        <div className="grid">
            <div className="col-12">
                <div className="card docs no-margin">
                    ...
                    <p>
                        Freya is an application template for React, based on the popular <a href="https://github.com/facebookincubator/create-react-app">create-react-app</a> that allows creating React apps with no configuration. To get started
...
`}
                    ...
                    <h4>Structure</h4>
                    <p>
                        Freya consists of 3 main parts; the application layout, layout resources and theme resources for PrimeReact components. <b>App.js</b> inside src folder is the main component containing the template for the base layout whereas
...
`}
                    ...
                    <p>
                        Variables of the light component theme, see the <a href="https://www.primefaces.org/designer/api/primereact/6.0.0/">Theme Designer API</a> for documentation.
                    </p>
