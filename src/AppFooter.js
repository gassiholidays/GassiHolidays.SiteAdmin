                    ...
                    <div className="grid">
                        <div className="col-6 ">
                            ...
                            <ul>
                                ...
                                <li>
                                    <button className="p-link" onClick={() => navigate('pages/crud')}>
                                        Crud
                                    </button>
                                </li>
                                <li>
                                    <button className="p-link" onClick={() => navigate('/pages/invoice')}>
                                        Invoice
                                    </button>
                                </li>
                                <li>
                                    <button className="p-link" onClick={() => navigate('/pages/help')}>
                                        Help
                                    </button>
                                </li>
                            </ul>
                        ...
                        <div className="col-6">
                            ...
                            <ul>
                                <li>
                                    <button className="p-link" onClick={() => navigate('/pages/calendar')}>
                                        Calendar
                                    </button>
                                </li>
                                <li>
